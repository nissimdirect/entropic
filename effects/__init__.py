...
EFFECTS = {
    ...
    "ringmod": {
        ...
        "param_ranges": {"frequency": {"min": 0.5, "max": 20.0}, "depth": {"min": 0.0, "max": 5.0}},
    ...
    "pixeldynamics": {
        ...
        "param_ranges": {"viscosity": {"min": 0.01, "max": 1.0}, "turbulence": {"min": 0.5, "max": 10.0}, "speed": {"min": 0.1, "max": 4.0}},
    ...
    "pixelcosmos": {
        ...
        "param_ranges": {"mass": {"min": 1.0, "max": 30.0}, "spin": {"min": 0.0, "max": 10.0}},
    ...
    "pixelorganic": {
        ...
        "param_ranges": {"num_portals": {"min": 1, "max": 15}, "pull_strength": {"min": 1.0, "max": 15.0}},
    ...
    "pixeldecay": {
        ...
        "param_ranges": {"generations": {"min": 1, "max": 30}},
